...
struct PhotoFrameViewThree: View {
    let image: UIImage
    ...
    // ThreeView特有：图片显示区域高度为边框宽度*0.94
...
extension ThreeView {
    ...
    private func captureAndSaveImage() {
        ...
        // 使用ImageExporter保存图片（ThreeView专用方法）
        ImageExporter.savePhotoFrameThree(
            image: selectedImage,
