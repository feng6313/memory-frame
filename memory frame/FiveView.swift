...
struct PhotoFrameViewFive: View {
    let image: UIImage
    ...
    private var verticalMargin: CGFloat {
        frameHeight * 0.25 // 上下边框间距 = 边框高度*0.25
    }
...
extension FiveView {
    ...
    private func saveImageToPhotoLibrary() {
        ...
        // 使用ImageExporter保存图片（FiveView专用方法）
        ImageExporter.savePhotoFrameFive(
            image: selectedImage,
