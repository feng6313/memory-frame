...
struct PhotoFrameViewEight: View {
    let image: UIImage
                ...
                VStack(spacing: 0) {
                    ...
                    VStack {
                        ...
                        HStack {
                            ...
                            .padding(.leading, 15) // user_s和独家记忆向右移动15点
                            ...
                            Image("three points")
                                ...
                                .foregroundColor(iconColor)
                                .padding(.trailing, 15) // three points向左移动15点
                        }
                     ...
                     VStack(spacing: 0) {
                        // 4个图标，放在图片下方8点处
                         HStack(spacing: 0) {
                             ...
                             .padding(.leading, 15) // heart、comment、share向右移动15点
                             ...
                             Image("collect")
                                 ...
                                 .frame(width: 26, height: 26)
                                 .foregroundColor(iconColor)
                                 .padding(.trailing, 15) // collect向左移动15点
                         }
                         .padding(.horizontal, horizontalMargin)
                         .padding(.top, 8)
                         .padding(.bottom, 12)
                        ...
                        HStack {
                            ...
                            .padding(.leading, horizontalMargin + 15) // 文字和地点向右移动15点
...
extension EightView {
    ...
    private func saveImageToPhotoLibrary() {
        ...
        // 使用ImageExporter保存图片（EightView专用方法）
        ImageExporter.savePhotoFrameEight(
            image: selectedImage,
